<a href="#" class="click-to-detail" data-id="{{$clients->getNumTicket->numTicket}}">
    <div class="col-md-12 col-sm-12 col-xs-12 responsive">
        <div class="info-box search-list-item {{($clients->event->countAllTicketAccess() == 0)?('search-list-grey'):(($clients->event->countAllTicketAccess() <= 2)?('search-list-red'):('search-list-default'))}} {{($clients->status_id > 1)?('search-list-vip'):('')}}">
